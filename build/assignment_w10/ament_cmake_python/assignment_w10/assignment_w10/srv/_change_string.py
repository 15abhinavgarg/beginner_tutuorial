...
class Metaclass_ChangeString_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('assignment_w10')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ChangeString(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'assignment_w10.srv.ChangeString')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from assignment_w10.srv import _change_string
...
class ChangeString(metaclass=Metaclass_ChangeString):
    from assignment_w10.srv._change_string import ChangeString_Request as Request
    from assignment_w10.srv._change_string import ChangeString_Response as Response
