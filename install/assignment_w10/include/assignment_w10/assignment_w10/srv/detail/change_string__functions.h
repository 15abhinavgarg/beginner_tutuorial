...
#ifndef ASSIGNMENT_W10__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
#define ASSIGNMENT_W10__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
...
#include "assignment_w10/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment_w10
bool
 ...
 * calls
 * assignment_w10__srv__ChangeString_Request__init().
...
/**
 * It calls
 * assignment_w10__srv__ChangeString_Request__fini()
 ...
 * assignment_w10__srv__ChangeString_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * assignment_w10__srv__ChangeString_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * assignment_w10__srv__ChangeString_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment_w10
...
/**
 * It calls
 * assignment_w10__srv__ChangeString_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment_w10
...
/**
 * It allocates the memory for the array and calls
 * assignment_w10__srv__ChangeString_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_assignment_w10
...
/**
 * It calls
 * assignment_w10__srv__ChangeString_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ASSIGNMENT_W10__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
